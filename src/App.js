...
// ─── Shared UI atoms ──────────────────────────────────────────────────────────
const s = (obj) => obj // identity — just for readability of inline style objects
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {enquiries.map((e, i) => (
              ...
              >
                <td style={{ ...cellStyle, color: C.ltBlue, fontWeight: 600 }}>
                  {e.id}
                </td>
                <td style={cellStyle}>{e.client}</td>
                <td style={cellStyle}>{e.project}</td>
                <td style={{ ...cellStyle, color: '#7D8590' }}>{e.received}</td>
                <td style={{ ...cellStyle, color: '#7D8590' }}>{e.due}</td>
                <td style={cellStyle}>
            ...
            <tbody>
              {drawings.map((d, i) => (
                ...
                >
                  ...
                  <td style={{ ...tdStyle, maxWidth: 200 }}>{d.title}</td>
                  <td style={tdStyle}>
                    <Badge
                      label={d.type}
                  ...
                  <td style={{ ...tdStyle, color: '#7D8590' }}>{d.rev}</td>
                  <td
                    style={{
                      ...tdStyle,
                      color: '#7D8590',
